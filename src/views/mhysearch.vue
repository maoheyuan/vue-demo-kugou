    ...
    mixins:[INIT,PLAY_AUDIO],
      ...
      methods:{
          getList(){
              ...
              this.$http.get('http://cs003.m2828.com/apis/proxy.php?val=&url1=http://mobilecdn.kugou.com/api/v3/search/hot?plat=0&count=30&url2=').then(
                  res=>{
          ...
          search(){
              ...
              this.$http.get(
                  'http://cs003.m2828.com/apis/proxy.php?val=' +
                  '&url1=http://mobilecdn.kugou.com/api/v3/' +
                  'search/song?keyword='+this.keyword+'&page=1&pagesize=30&url2=').then(res=>{
